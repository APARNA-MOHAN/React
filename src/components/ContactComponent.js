                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            ...
                            <a role="button" className="btn btn-info" href="_blank"><i className="fa fa-skype"></i> Skype</a>
                        ...
                        <LocalForm onSubmit={(values)=>this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={{size: 3, offset: 1}}>
                                    <Control.select model=".contacttype" name="contactType" className="form-check-input">
                                        <option>Tel.</option>
                                        <option>Email</option>
                                    </Control.select>
                                </Col>
